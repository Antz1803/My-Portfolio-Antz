                ...
                <div className="relative w-full max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-8 px-1 mt-10">
                    ...
                    <div className={`${glassStyle} relative flex flex-col justify-between border-t border-r border-orange-500/40 min-h-[250px]`} style={{ clipPath: 'polygon(0% 0%, 85% 0%, 100% 15%, 100% 100%, 0% 100%)', boxShadow: 'inset 0 0 20px rgba(249, 115, 22, 0.05)' }}>
                        ...
                        <div className="pt-6 px-6">
                            ...
                            <p className="text-white text-xl font-medium">Not Available for Hire</p>
                            <p className="text-white/40 text-[11px] mt-2 italic">Full-Time IT Instructor at Cebu Eastern College with experience teaching multiple Information Technology courses. Passionate about developing students' technical skills through interactive learning, practical applications, and industry-relevant instruction. Dedicated to fostering academic excellence and preparing future IT professionals for successful careers in technology.</p>
                        </div>
                        <div className="p-6">
                            <button
                                onClick={() => {
